...
This project provides production-ready time series forecasting using multiple machine learning models (Ridge, Lasso, LightGBM, XGBoost, CatBoost) with advanced features including uncertainty quantification, feature importance analysis, and robust validation.

## Features

✅ **5 ML Models**: Ridge, Lasso, LightGBM, XGBoost, CatBoost with ensemble
...
| CatBoost   | Impute only          | Handles categoricals natively      | Mixed data types     |
